...
...
kr1_2sem/
├── pr1/          # Задание 1 — Вёрстка страница карточки
├── pr2/          # Задание 2 — CRUD-интерфейс
├── pr3/          # Задание 3 — Работа с Postman
├── pr4-5/          # Задание 4–5 — REST API + React-клиент + Задание 7-11 - Авторизация и токены
